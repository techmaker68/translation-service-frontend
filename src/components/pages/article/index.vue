<template>
  <div class="container mt-5">
    ...
    <div class="d-flex gap-2 align-items-center mb-3">
      <input type="text" class="form-control" v-model="searchQuery" placeholder="Search by key, content, or tags"
    ...
    <article-form v-if="showArticleForm" @close="hideForm" @submit="fetchTranslations"
      :currentArticle="currentArticle"></article-form>

    <!-- Translation List -->
    <ul class="list-group">
      <li v-for="translation in filteredTranslations" :key="translation.id" class="list-group-item">
        <div class="d-flex justify-content-between align-items-center">
          <div>
            ...
            <p>
              ...
              {{ new Date(translation.created_at) }}
            </p>
...
import { gettranslations, searchTranslations, deletetranslations, exportTranslations } from "@/api/translations";
...
export default {
  ...
  methods: {
    async fetchTranslations() {
      try {
        ...
        // Fetch translations with search filter
    ...
    async deleteTranslation(id) {
      try {
        const response = await deletetranslations(id);
    ...
    async exportJsonData() {
      ...
      const  response = await exportTranslations()
        ...
        // Open the JSON data in a new tab
  ...
  computed: {
    filteredTranslations() {
      return this.translations; // API handles search filtering
    },
  },
};
</script>
